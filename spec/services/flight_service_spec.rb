   ...
   describe ".reduce_seats" do
    ...
    context "when booking is successful" do
      it "reduces available seats and returns true" do
        result = FlightService.reduce_seats(flight.flight_number, flight.departure_datetime, "Economy", 3)
    ...
    context "when travellers_count is zero" do
      it "returns false and does not change seats" do
        result = FlightService.reduce_seats(flight.flight_number, flight.departure_datetime, "Economy", 0)
    ...
    context "when travellers_count exceeds available seats" do
      it "returns false and does not change seats" do
        result = FlightService.reduce_seats(flight.flight_number, flight.departure_datetime, "Economy", 15)
    ...
    context "when flight does not exist" do
      it "returns false" do
        result = FlightService.reduce_seats("INVALID", flight.departure_datetime, "Economy", 1)
    ...
    context "when class_type does not exist" do
      it "returns false" do
        result = FlightService.reduce_seats(flight.flight_number, flight.departure_datetime, "First Class", 1)
    ...
    context "when an unexpected error occurs" do
      it "returns false" do
        ...
        result = FlightService.reduce_seats(flight.flight_number, flight.departure_datetime, "Economy", 1)
